...
const WORDS = {
  uz: {
    ...
    total: "Jami",
    comment: "Izoh",
    cardWarning: "⚠️ Karta to'lovi — tushganini tekshiring va panelda «To'landi» deb belgilang",
  ...
  ru: {
    ...
    total: "Итого",
    comment: "Комментарий",
    cardWarning: "⚠️ Оплата картой — проверьте поступление и отметьте «Оплачено» в панели",
    delivery: "🛵 Доставка",
    pickup: "🚶 Самовывоз",
